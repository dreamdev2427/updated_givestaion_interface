  ...
  const changeFile = (event) => {
    ...
    reader.onload = () => {
      if (file.size > 2097152) {
        NotificationManager.warning(
          "File size should be equal or less than 2MB"
        );
  ...
  return (
    <div className=" dark:bg-slate-900">
      ...
      <section className="pt-16 pb-4 heading dark:bg-slate-900 ">
        <h1 className="text-2xl text-center font-bolder dark:bg-slate-900 dark:text-white ">
          Create a new grant
        </h1>
      </section>
      <section className="w-10/12 py-6 mx-auto form md:w-6/12 ">
        <div
          className="my-3 mb-6 form-group"
        ...
        >
          ...
          <div className="relative">
            ...
            {dropdown ? (
              <div
                id="dropdown"
                className="absolute z-10 bg-white divide-y divide-gray-100 rounded shadow top-12 w-60 dark:bg-gray-700"
              >
                <ul
        ...
        <div className="my-3 mb-6 form-group">
          ...
          <div className="flex flex-wrap">
            <input
              type="number"
              className="w-full py-3 bg-white border-0 rounded-lg focus:outline-none focus:ring-0 text-slate-800 shadow-secondary sm:w-10/12 md:w-10/12 lg:w-10/12"
              onChange={(e) => {
                onChangeMinimum(e.target.value);
              }}
              value={minimum}
            ></input>
            <div className="w-full mt-4 sm:w-2/12 md:w-2/12 lg:w-2/12 sm:mt-0">
              <button className="w-full px-0 py-3 font-bold text-white rounded-lg ethbtn bg-gradient-primary lg:px-4 sm:ml-2">
                {chainId ? chains[chainId.toString()].nativeCurrency : "ETH"}
              </button>
            </div>
          </div>
        </div>
        <div className="my-3 mb-6 form-group">
          ...
          <div className="flex flex-wrap">
            <input
              type="text"
              className="w-full py-3 bg-white border-0 rounded-lg focus:outline-none focus:ring-0 text-slate-800 sm:w-12/12 shadow-secondary"
              onChange={(e) => {
        ...
        <div className="flex flex-row my-1 form-group">
          <label className="block w-4/12 mb-2 text-center sm:w-12/12 dark:text-gray-100 ">
            Website/Github
          </label>
          <label className="block w-4/12 mb-2 text-center sm:w-12/12 dark:text-gray-100">
            Twitter
        ...
        <div className="flex flex-row my-1 mb-6 form-group">
          <input
            type="text"
            className="w-4/12 py-3 mx-1 bg-white border-0 rounded-lg focus:outline-none focus:ring-0 text-slate-800 sm:w-12/12 shadow-secondary"
        ...
        <div className="my-3 mt-12 mb-6 form-group">
          <button
            className="flex items-center justify-center w-full py-3 font-bold text-center text-white rounded-lg campaignbtn bg-gradient-primary sm:w-12/12 shadow-primary"
            onClick={() => {
                ...
                <div className="mx-auto connect-popup">
                  ...
                  <div className="px-3 text-center">
                    <div className="flex justify-center">
                      <img
                        src="/images/creation complete.png"
                        alt="casual"
                        className="mx-auto"
                      />
                    </div>
                    <h6 className="mt-3 mb-1 text-sm font-bold text-white md:text-2xl">
                      you have successfully created a new grant!
                    </h6>
                    ...
                    <div className="flex w-11/12 mx-auto md:w-8/12 input-group">
                      <input
                        ...
                        placeholder="Share your grant on Twitter"
                      />
                      <CopyToClipboard
                        text={`${window.location.origin}/campaign/${createdAddress}`}
