...
const Card = ({ title = "", imgSrc }) => {
  return (
    <div className="gradient-bg  dark:bg-gradient-to-b	from-[#3BA0E7] via-[#5CC6FF] to-[#A778E4] rounded-xl card-shadow p-4 text-White font-bold">
      ...
      <h2 className="font-bold text-2xl	mb-4">60</h2>
    </div>
  );
};
          ...
          <div className="px-5 lg:px-8 mt-8">
            <div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4  gap-4 md:gap-6 my-9">
                <Card title="DONATIONS" imgSrc="donations" />
                <Card title="AMOUNT DONATED" imgSrc="3-User" />
                <Card title="CAMPAIGNS" imgSrc="myprojects" />
                <Card title="GIVEPOINTS" imgSrc="donations" />
              </div>
